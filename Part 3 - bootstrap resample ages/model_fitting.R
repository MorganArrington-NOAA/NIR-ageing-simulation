...
# load data
load("Z:/NIR-ageing-simulation/Data/boot_dat_10_og.rda")
load("Z:/NIR-ageing-simulation/Data/all_dat_filt.rda")
...
system.time(
jitter_mod_list <- future_map(samp, jitter_age_mod, seed=TRUE)
)
...
# Output data
write.csv(preds_df, "Z:/NIR-ageing-simulation/Data/part 3 preds_indageerror_iter10_2013_og.csv") # preds_df - this can be used to calculate the rest
